...
@property (nonatomic, strong) UIView *rightTranslucentView;
@property (nonatomic, strong) UIView *translucentRightView;
...
- (void)initCDRTranslucentSideBar {
    _hasShown = NO;
    [[NSNotificationCenter defaultCenter] postNotificationName:BBNotificationToMenuItemBar object:nil];
